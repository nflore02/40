...
extern void print_six(Seq_T stream);
extern void conditional_move(Seq_T stream);
extern void load_seg(Seq_T stream);
extern void load_prgm_test(Seq_T stream);
...
static struct test_info {
        ...
        { "arith", NULL, "", arith_test},
        { "print-H", NULL, "6", print_six},
        { "conditional", NULL, "", conditional_move},
        { "load_seg", NULL, "", load_seg},
        { "load_prgm", NULL, "", load_prgm_test },
        { "map", NULL, "", map_test }
};
